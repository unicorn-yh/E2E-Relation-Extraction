...
class E2EDataset(Dataset):
    def __init__(self):
        ...
        '''
        #self.data, src, tgt = self.get_data(data_path)
    ...
    '''
            __getitem__()函数的内容：
            根据index读取输入输出序列，并根据词典转化为对应的id序列
        '''
    ...
    def build_vocab(self, data, src, tgt):
        src.build_vocab(data, max_size=50000)
        tgt.build_vocab(data, max_size=50000)
